...
- [ ] `ctest` の既存テストが全て PASS/SKIP (FAIL なし)
- [ ] `grep -r "get_openjtalk_voice_path" src/cpp/` が 0 件
- [ ] `grep -r "HTS_VOICE_URL" src/cpp/` が 0 件
...
| 3.7 | テスト CMake 更新 | `src/cpp/tests/CMakeLists.txt` | L25, L252, L335, L456, L663, L747, L830 | `${CMAKE_BINARY_DIR}/hts_stub/include` を 7 箇所から削除 |
