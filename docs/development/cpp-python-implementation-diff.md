...
M1-M4完了後、PR #229のCI全チェック通過のために以下を修正:
...
| `35c2e87` | phoneme_ids.cppのクラッシュ防止 + テストモデルにPUAトークン追加 |
| `0cb7b42` | 辞書ダウンロードCIテスト修正 |
| `8ced3d2` | test_japanese_tts.pyをM1.5アーキテクチャに適合 |

### 残課題
- なし（全マイルストーン完了、CI全チェック通過待ち）
