...
**関連**: [ci-expansion-milestones.md](./ci-expansion-milestones.md) §M-Stretch
**作成日**: 2026-05-18
...
親調査 [ci-expansion-2026-05.md](./ci-expansion-2026-05.md) §3 横断テーマと [ci-expansion-milestones.md §M-Stretch](./ci-expansion-milestones.md#m-stretch-strategic-bets-month-4-候補) は、 通常の「**人間 1 名が 4 週で着手できるか**」 という工数モデルで採否を判定していた。 PR #511 でも同じ基準で 8 項目を defer した。
...
[ci-expansion-milestones.md §M-Stretch](./ci-expansion-milestones.md#m-stretch-strategic-bets-month-4-候補) Distroless 行と紐づく個別 milestone として、 5 image を **1 image / 1 PR** の cadence で段階移行。 Claude Code が Dockerfile を書き換えるのは即時可能だが、 各 PR で **「user が HF Space に手動 push して動作確認」 する手順** を Test Plan に含める必要がある。
...
[ci-expansion-milestones.md §M-Stretch](./ci-expansion-milestones.md#m-stretch-strategic-bets-month-4-候補) SLSA Build L3 行と紐づく個別 milestone。 **1 registry / 1 PR** の cadence で、 各 PR は (a) workflow 改変、 (b) v1.13.0-rc.X で actual release、 (c) verifier で attestation 確認、 を 1 set として含める。 Claude Code は workflow YAML を書けるが、 各 step の RC release は user の判断で実行。
...
- [ci-expansion-milestones.md](./ci-expansion-milestones.md) — Top 10 マイルストーン分解
- [ci-expansion-milestones.md §M-Stretch](./ci-expansion-milestones.md#m-stretch-strategic-bets-month-4-候補) — M-Stretch S1-S8 候補一覧
