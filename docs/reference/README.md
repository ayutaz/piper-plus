...
| Python 3.13 移行 (実装完了) | [`../archive/python-313/`](../archive/python-313/) | Issue #527 — PR #569 で実装完了。 default Python 3.11 → 3.13 + CUDA 12.6 → 12.8 + Ubuntu 22.04 → 24.04。 設計ドキュメント (要求 / 要件 / マイルストーン / 未決事項 / 実装計画) は archive に保管 |
