...
> [`docs/guides/platform/swift-g2p-integration.md`](../guides/platform/swift-g2p-integration.md)
...
実装の詳細は実コードを真とし、本仕様は方針・契約・採用しなかった案を残すことに専念する。API/JSON envelope/ABI 互換性の規範定義は [`docs/spec/swift-g2p-contract.toml`](../spec/swift-g2p-contract.toml) を参照。
...
API/JSON envelope/ABI の規範は [`docs/spec/swift-g2p-contract.toml`](../spec/swift-g2p-contract.toml) に集約。利用者向けの解説は [`docs/guides/platform/swift-g2p-integration.md`](../guides/platform/swift-g2p-integration.md)。
...
| 利用ガイド / consumer 向け FAQ | [`docs/guides/platform/swift-g2p-integration.md`](../guides/platform/swift-g2p-integration.md) |
...
- 利用ガイド: [`docs/guides/platform/swift-g2p-integration.md`](../guides/platform/swift-g2p-integration.md)
- ABI 契約: [`docs/spec/swift-g2p-contract.toml`](../spec/swift-g2p-contract.toml)
- 既存 iOS 仕様: [`docs/reference/ios-shared-lib.md`](./ios-shared-lib.md)
- 既存 iOS ガイド: [`docs/guides/platform/ios-integration.md`](../guides/platform/ios-integration.md)
