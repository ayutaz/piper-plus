...
API/JSON envelope/ABI の規範は [`docs/spec/swift-g2p-contract.toml`](./swift-g2p-contract.toml) に集約。利用者向けの解説は [`docs/guides/platform/swift-g2p-integration.md`](../guides/platform/swift-g2p-integration.md)。
