...
| **post-merge: 実機 smoke 失敗による hotfix が必要** | smoke FAIL → fix が大きい | `v1.13.0rc1` 等の pre-release で吸収、 fix 完了後に GA release (DR-009) |
...
- [ ] `training-guide.md` / `CLAUDE.md` に「v1.13 では過去 ckpt の resume 非サポート」 を明記 (DR-006)
...
- [ ] (任意) `v1.13.0rc1` pre-release で early access フィードバック取得済
