...
> **調査日**: 2026-04-05
> **最終更新**: 2026-04-05 (Tier 2 施策: warmup / cache / 日本語音素化キャッシュ 反映済み)
...
| 設定 | 値 | 根拠 |
|------|-----|------|
| `intra_op_num_threads` | `min(論理コア/2, 4)` | 論理コア数の半分を物理コア相当の近似値として使用。VITS は 15-75MB の小モデルで、4以上では同期オーバーヘッドが支配的 |
