...
|----|----------|----------|----------|--------|-----------|
| M3.1 | Public ABI snapshot (C / Swift / Kotlin) | #4 | 3 PR (~25h) | 高 | 実装完了 (PR #511, bootstrap baseline) |
| M3.2 | Model card / license auto-injection | #7 | 2 PR (~15h) | 中 | 実装完了 (PR #511, deploy workflow hook 注入済) |
| M3.3 | Typosquatting weekly scan | #8 | 2 PR (~12h) | 中 | 実装完了 (PR #511) |
