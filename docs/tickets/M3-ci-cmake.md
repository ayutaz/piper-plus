...
- 状態: 未着手
- 推定削除行数: ~120行 (実 HTS Engine ビルドパス 51行 + CI stub 手動作成 23行 + PiperLink 分岐 26行 + PiperPlusShared 分岐 9行 + CI 環境変数 1行 + tests/CMakeLists.txt 7行 + HTSEngine_CMakeLists.txt 93行ファイル削除)
