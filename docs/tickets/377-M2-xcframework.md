...
| T15 | **Swift `import PiperPlus` 構文成立 (CI 内)** | macos-14 runner 上で test-only `swift -I piper_plus.xcframework/ios-arm64/Headers -framework PiperPlus -emit-module` 等で modulemap 解釈成功 (実機 import 検証は M4 SPM 経由で代替) |
