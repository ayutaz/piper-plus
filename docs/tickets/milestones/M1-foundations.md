...
**Milestone ID**: `M1`
**Tier**: Tier 1
**Status**: 完了 (2026-05-19、 PR #513 merge)
...
|----|--------|---------|------|--------|----|
| [T-001](../tickets/T-001-rekor-verify.md) | Rekor verify workflow | `#3a` | informational | 完了 | #513 |
| [T-002](../tickets/T-002-action-sha-drift.md) | Action SHA drift detector | `#3b` | informational | 完了 | #513 |
| [T-003](../tickets/T-003-cli-help-extract.md) | 6 runtime CLI help auto-extract | `#4` | PR=blocker / weekly=informational | 完了 | #513 |
...
| 2026-05-19 | M1 完了反映 (PR #513 merge: commit c29a87ec)、 3 ticket 全 Status を「完了」 + PR# を記録 | Claude Code |
