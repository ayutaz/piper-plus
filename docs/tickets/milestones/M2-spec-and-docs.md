...
|----|--------|---------|------|--------|----|
| [T-004](../tickets/T-004-release-versions-spec.md) | `release-versions.toml` gate | `#5-1` | blocker | 完了 (既存実装) | #517 |
| [T-005](../tickets/T-005-model-sha256-spec.md) | `model-sha256-manifest.toml` gate | `#5-2` | blocker | 完了 (構造健全性 scope) | #517 |
| [T-006](../tickets/T-006-artifact-retention-spec.md) | `artifact-retention-contract.toml` gate | `#5-3` | blocker | 完了 (sweep + mode=fail) | #517 |
| [T-007](../tickets/T-007-swift-g2p-spec.md) | `swift-g2p-contract.toml` gate | `#5-4` | blocker | 完了 (既存実装) | #517 |
| [T-008](../tickets/T-008-test-flake-retry-spec.md) | `test-flake-retry-contract.toml` gate | `#5-5` | blocker | 完了 (4 runtime scope) | #517 |
