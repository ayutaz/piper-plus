...
| `src/csharp/PiperPlus.Core.Tests/VoiceCatalogTests.cs` | カタログテスト | 完了 |
| `src/csharp/PiperPlus.Core.Tests/ModelManagerTests.cs` | モデル管理テスト | 完了 |
| `src/csharp/PiperPlus.Core.Tests/Phase4IntegrationTests.cs` | Phase 4 統合テスト | 完了 |
...
| `src/csharp/PiperPlus.Core.Tests/ArpabetToIPAConverterTests.cs` | ARPABET→IPA変換テスト | 完了 |
| `src/csharp/PiperPlus.Core.Tests/EnglishPhonemizerTests.cs` | 英語音素化テスト | 完了 |
| `src/csharp/PiperPlus.Core.Tests/EnglishPostProcessIdsTests.cs` | BOS/EOS/PADテスト | 完了 |
...
| Phase 3 | (既存テストファイルに追加) | - | 完了 |
| Phase 4 | VoiceCatalogTests.cs | - | 完了 |
| Phase 4 | ModelManagerTests.cs | - | 完了 |
| Phase 4 | Phase4IntegrationTests.cs | - | 完了 |
| Phase 5 | ArpabetToIPAConverterTests.cs | - | 完了 |
| Phase 5 | EnglishPhonemizerTests.cs | - | 完了 |
| Phase 5 | EnglishPostProcessIdsTests.cs | - | 完了 |
| **合計** | | **72+** | |
