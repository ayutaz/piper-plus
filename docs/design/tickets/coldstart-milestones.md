...
| # | チケット | タイトル | 期間 | 期待削減量 | 対象 | リスク |
|---|---------|---------|------|-----------|------|--------|
| M1 | [COLD-M1](coldstart-m1.md) | クイックウィン（ORT設定修正） | 1週間 | ~300–500ms | Rust / C# | 低 |
| M2 | [COLD-M2](coldstart-m2.md) | Warmup（ダミー推論） | 1–2週間 | ~800ms（初回） | 全プラットフォーム | 低〜中 |
| M3 | [COLD-M3](coldstart-m3.md) | 非同期バックグラウンド並列化 | 1–2週間 | ~200–400ms | 全プラットフォーム | 中 |
| M4 | [COLD-M4](coldstart-m4.md) | 辞書バイナリ形式化 | 2週間 | ~350–600ms | Rust / WASM | 中 |
| M5 | [COLD-M5](coldstart-m5.md) | 事前最適化済みモデル配布 | 2週間 | ~500ms（2回目以降も） | Rust / C# | 中〜高 |
| M6 | [COLD-M6](coldstart-m6.md) | .NET ReadyToRun + GPU 検出キャッシュ | 1週間 | ~100–200ms | C# / Rust | 低 |
