...
- **piper-plus 該当箇所:** `src/python/piper_train/export_onnx.py` (**今後追加提案**の `--quantize int8|int4` フラグ — 現状の export_onnx.py には未実装、 本施策で新規導入する想定)、 配布パッケージ metadata (PyPI / NuGet / crates.io / npm の 7 箇所)
...
| companion (Q10〜Q20) | 2 (Q15 / Q16) | 4 (Q10 / Q11 / Q12 / Q17) | 5 (Q13 / Q14 / Q18 / Q19 / Q20) | 11 |
| **合計** | **5** | **7** | **8** | **20** |

companion §2.5 末尾「Phase 2-4 オープンクエスチョン総括表」と同データ (companion 集計: R2/C4/I5=11)。
...
|------|---------------|------------------|-------------------|
| サポート言語 (G2P) | 8 (JA/EN/ZH/KO/ES/PT[BR/EU dialect]/FR/SV — PT-BR/PT-EU は 1 言語の方言扱い) | 11 (+ TR/AR/BN G2P+acoustic) | 15+ (+ DE/IT/NL/PL/HI/SW、 VI/TL は G2P-only ※) |
