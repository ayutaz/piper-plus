...
| タスク | 工数 |
|-------|-----|
| CREMA-D DL + 前処理 + manifest | 1 日 |
| Stage 5a 学習 (200ep) + 評価 | 2 日 (GPU 24h + 評価並行) |
| Stage 5b (Phase 4 完了後) | 1.5 日 |
| 評価 (MOS スクリプト + リスナーテスト配布・集計) | 2 日 |
| ドキュメント (実験報告、fine-tune ガイド) | 1 日 |
| **合計** | **5〜7 日** |

**並列**: GPU 学習中 (24h) に評価ツール準備等を並行
