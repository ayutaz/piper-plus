...
#
get_filename_component(filename "/Users/s19447/Desktop/piper/test-build/h/src/hts_engine_API-1.10.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/s19447/Desktop/piper/test-build/h/src/hts_engine_external" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-hts_engine_external${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-hts_engine_external${i}")
