...
#
get_filename_component(filename "/Users/s19447/Desktop/piper/test-build/o/src/open_jtalk-1.11.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/s19447/Desktop/piper/test-build/o/src/openjtalk_external" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-openjtalk_external${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-openjtalk_external${i}")
