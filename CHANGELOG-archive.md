...
Older piper-plus releases (v1.5.0 and prior), archived from [CHANGELOG.md](CHANGELOG.md) for readability.

Format: [Keep a Changelog](https://keepachangelog.com/en/1.0.0/), SemVer: [SemVer 2.0.0](https://semver.org/spec/v2.0.0.html).
