...
public sealed class InlinePhonemeParserTests
{
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("Hello world");
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("[[ h @ l oU ]]");
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("Hello [[ h @ l oU ]] world");
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("[[ a ]] and [[ b ]]");
    ...
    {
        Assert.Empty(InlinePhonemeParser.Parse(string.Empty));
    }
    ...
    public void Parse_NestedBrackets_TreatedAsText()
    {
        ...
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("[[ [[ a ]] ]]");
    ...
    public void Parse_EmptyBrackets_EmptyPhonemeSegmentKept()
    {
        ...
        Assert.True(result[1].IsPhonemes);
        Assert.Equal(string.Empty, result[1].Text);
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("hello [ not phonemes ] world");
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("[[ a ]][[ b ]]");
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("[[ a b ]] followed by text");
    ...
    {
        List<TextOrPhonemes> result = InlinePhonemeParser.Parse("text before [[ a b ]]");
