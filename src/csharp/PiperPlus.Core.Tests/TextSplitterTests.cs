...
public class TextSplitterTests
{
    ...
    {
        List<string> result = TextSplitter.SplitSentences("Hello world.");
    ...
    {
        List<string> result = TextSplitter.SplitSentences("Hello. How are you? Fine!");
    ...
    {
        List<string> result = TextSplitter.SplitSentences(
            "\u3053\u3093\u306b\u3061\u306f\u3002\u4eca\u65e5\u306f\u826f\u3044\u5929\u6c17\u3067\u3059\u306d\u3002");
    ...
    {
        List<string> result = TextSplitter.SplitSentences("She said \"Hello.\" Then left.");
        Assert.Equal(2, result.Count);
    ...
    public void ClosingPunctuation_RightPointingDoubleAngleQuotationMark()
    {
        ...
        List<string> result = TextSplitter.SplitSentences("\u00ABBonjour.\u00BB Au revoir.");
        Assert.Equal(2, result.Count);
    ...
    {
        List<string> result = TextSplitter.SplitSentences(string.Empty);
        Assert.Empty(result);
    }
    ...
    {
        List<string> result = TextSplitter.SplitSentences(null!);
        Assert.Empty(result);
    }
    ...
    {
        List<string> result = TextSplitter.SplitSentences("This has no ending punctuation");
        Assert.Single(result);
    ...
    public void ConsecutiveTerminators()
    {
        ...
        List<string> result = TextSplitter.SplitSentences("Really?! Yes.");
        Assert.Equal(3, result.Count);
    ...
    {
        List<string> result = TextSplitter.SplitSentences("Hello.\nWorld.");
        Assert.Equal(2, result.Count);
        Assert.Equal("Hello.", result[0]);
        Assert.Equal("World.", result[1]);
    }
    ...
    {
        List<string> result = TextSplitter.SplitSentences("A. B.");
        Assert.Equal(2, result.Count);
    ...
    public void SplitSentences_PreservesSpeakEnvelope()
    {
        ...
        List<string> result = TextSplitter.SplitSentences("<speak>A. B.</speak>");
        Assert.Single(result);
    ...
    public void SplitSentences_SpeakWithAttributes()
    {
        ...
        List<string> result = TextSplitter.SplitSentences("<speak version=\"1.0\">A. B.</speak>");
        Assert.Single(result);
    ...
    public void SplitSentences_SpeakWithInnerPeriods()
    {
        ...
        List<string> result = TextSplitter.SplitSentences("<speak>A.B.C.</speak>");
        Assert.Single(result);
    ...
    public void SplitSentences_TextAfterSpeakCloseSplitsNormally()
    {
        ...
        List<string> result = TextSplitter.SplitSentences("<speak>A.</speak> Plain. Text.");
        Assert.Equal(3, result.Count);
    ...
    public void SplitSentences_UnclosedSpeakFallsBackToNormalSplit()
    {
        ...
        List<string> result = TextSplitter.SplitSentences("<speak>A. B.");
        Assert.Equal(2, result.Count);
