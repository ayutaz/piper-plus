...
JAPANESE_PHONEMES: list[str] = [
    ...
    "N",  # 撥音 (ん) — generic, used when N-variant rules are disabled
    "N_m",  # ん before m/b/p (bilabial)
    "N_n",  # ん before n/t/d/ts/ch (alveolar)
    "N_ng",  # ん before k/g (velar)
    "N_uvular",  # ん at end or before vowels
    "cl",  # 促音 / 終止閉鎖
