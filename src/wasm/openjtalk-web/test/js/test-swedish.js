...
describe('Segment-level scoring', () => {
    ...
    it('should use segmentText internally and return segments', () => {
        const segments = p.segmentText('björk');
...
describe('Mixed Swedish-Japanese', () => {
    ...
    it('should segment Swedish and Japanese separately', () => {
        const segments = p.segmentText('こんにちは björk');
