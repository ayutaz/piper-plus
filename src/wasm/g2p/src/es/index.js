/**
 * SpanishG2P -- character-based Spanish G2P for @piper-plus/g2p.
 *
...
export class SpanishG2P {
    ...
    /**
     * Convert Spanish text to phoneme tokens with prosody.
     * Spanish G2P does not provide prosody information, so prosody
