...
try:
    from .multilingual import MultilingualPhonemizer, Language, TextSegment
    from .multilingual_phoneme_map import get_multilingual_phoneme_mapper
except ImportError:
    from piper_train.phonemize.multilingual import MultilingualPhonemizer, Language, TextSegment
...
class MultilingualDatasetFormatter:
    ...
    def save_dataset(
        ...
        speaker_ids = set(utt.speaker_id for utt in utterances)
