...
Converts Swedish text to IPA phonemes using orthographic rules + NST
dictionary lookup. No espeak-ng dependency — all rules are native.
...
# ---------------------------------------------------------------------------
# Soft/Hard consonant decision (FR-03a)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Vowel phoneme assignment (FR-03d + FR-03e)
# ---------------------------------------------------------------------------
...
def _insert_stress_marker(
    ...
    # Don't walk past a previous vowel's consonant coda if this is not syl 0
