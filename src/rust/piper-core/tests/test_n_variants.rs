...
mod tests {
    ...
    fn test_n_before_vowel_a() {
        ...
        let mut tokens: Vec<String> = vec!["a", "N", "a"]
            .iter().map(|s| s.to_string()).collect();
        apply_n_phoneme_rules(&mut tokens);
    ...
    fn test_n_before_vowel_i() {
        ...
        let mut tokens: Vec<String> = vec!["a", "N", "i"]
            .iter().map(|s| s.to_string()).collect();
        apply_n_phoneme_rules(&mut tokens);
        assert_eq!(tokens[1], "N_uvular");
    }
    ...
    fn test_n_before_vowel_u() {
        ...
        let mut tokens: Vec<String> = vec!["a", "N", "u"]
            .iter().map(|s| s.to_string()).collect();
        apply_n_phoneme_rules(&mut tokens);
        assert_eq!(tokens[1], "N_uvular");
    }
    ...
    fn test_n_before_vowel_e() {
        ...
        let mut tokens: Vec<String> = vec!["a", "N", "e"]
            .iter().map(|s| s.to_string()).collect();
        apply_n_phoneme_rules(&mut tokens);
        assert_eq!(tokens[1], "N_uvular");
    }
    ...
    fn test_n_before_vowel_o() {
        ...
        let mut tokens: Vec<String> = vec!["a", "N", "o"]
            .iter().map(|s| s.to_string()).collect();
        apply_n_phoneme_rules(&mut tokens);
        assert_eq!(tokens[1], "N_uvular");
    }
    ...
    fn test_single_n_only() {
        ...
        let mut tokens: Vec<String> = vec!["N"]
            .iter().map(|s| s.to_string()).collect();
        apply_n_phoneme_rules(&mut tokens);
