...
## 🟢 現在の状態: 20話者 v2 モデル学習完了

**ブランチ**: `feature/issue-204-207-phoneme-enhancements`
...
| 発話数 | 60,164 |
| 話者数 | 20 |
| 新機能 | Issue #204, #207 (拡張音素) |
| ONNXモデル | `moe-speech-20speakers-v2.onnx` (74MB) |
| PR | #210 |
...
│   └── last.ckpt
└── moe-speech-20speakers-v2.onnx  ← 本番用モデル
```
