...
> **v1.12.0 Breaking changes (2026-05):** HiFi-GAN Decoder 削除 (MB-iSTFT 統一、`--mb-istft` フラグ廃止)、Flask -> FastAPI HTTP サーバー移行、HTS-voice / Unity UPM パッケージ削除、.NET 全プロジェクトを net10.0 LTS へ移行。
...
| 項目 | 詳細 |
|------|------|
| TFM | PiperPlus.Core: net10.0, PiperPlus.Cli: net10.0 |
