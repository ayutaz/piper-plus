...
17. **HuggingFace アップロード**: v4 バイリンガル + つくよみちゃん v4 をアップロード
18. **不要チェックポイント削除**: `output-bilingual-ja-en/lightning_logs/version_28/checkpoints/` に全200エポック分 (~176GB) が残存。`epoch=199` と `last.ckpt` 以外は削除してディスク節約可能
...
| **つくよみちゃん v4ベース finetune** | `/data/piper/output-tsukuyomi-finetune-v4/tsukuyomi-v4.onnx` | ✅ 500 epoch完了・ONNX変換済み (74MB, 2026-03-04) — チェックポイント変換方式 |
