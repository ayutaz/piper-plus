...
## 🟡 現在の状態: バイリンガル (JA+EN) モデル — WavLM無効、FP32、0 epochから学習中
...
| 項目 | 値 |
|------|-----|
| エポック | **0** / 200 — WavLM無効、FP32、0 epochから学習中 |
...
└── lightning_logs/version_22/checkpoints/  ← FP32、修正済みデータセット、学習中
```
