...
if(MSVC)
  ...
  if(NOT ONNXRUNTIME_DLL OR NOT EXISTS "${ONNXRUNTIME_DLL}")
    ...
    if(EXISTS "${ONNXRUNTIME_ZIP}")
      ...
      if(EXISTS "${ONNXRUNTIME_EXTRACT_DIR}/onnxruntime-win-${ONNX_ARCH}-${ONNXRUNTIME_VERSION}/lib/onnxruntime.dll")
        ...
        set(ONNXRUNTIME_INCLUDE_DIR "${ONNXRUNTIME_EXTRACT_DIR}/onnxruntime-win-${ONNX_ARCH}-${ONNXRUNTIME_VERSION}/include")
  ...
  if(ONNXRUNTIME_DLL AND EXISTS "${ONNXRUNTIME_DLL}")
    ...
    if(ONNXRUNTIME_INCLUDE_DIR)
      ...
      # Try to find include directory relative to lib
      get_filename_component(ONNXRUNTIME_PARENT_DIR "${ONNXRUNTIME_LIB_DIR}" DIRECTORY)
      if(EXISTS "${ONNXRUNTIME_PARENT_DIR}/include")
        set(ONNXRUNTIME_INCLUDE_DIR "${ONNXRUNTIME_PARENT_DIR}/include" PARENT_SCOPE)
      endif()
    endif()
  else()
    ...
    set(ONNXRUNTIME_INCLUDE_DIR "" PARENT_SCOPE)
  endif()
endif()