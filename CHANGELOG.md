...
任意のカスタムデータセットで piper-plus モデルをファインチューニング可能な汎用 Colab ノートブックを追加。事前学習済みベースモデル (6lang/つくよみちゃん等) からの転移学習に対応。
...
- HTS voice 依存を完全除去 (`refactor` #342) — ピュアな pyopenjtalk-plus パスのみ使用
