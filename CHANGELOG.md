...
- ドキュメント: [`docs/spec/swift-g2p.md`](docs/spec/swift-g2p.md) (仕様)、[`docs/guides/swift-g2p-integration.md`](docs/guides/swift-g2p-integration.md) (利用ガイド)、[`docs/spec/swift-g2p-decisions.md`](docs/spec/swift-g2p-decisions.md) (実装着手前判断記録)、[`docs/spec/swift-g2p-contract.toml`](docs/spec/swift-g2p-contract.toml) (FFI/ABI/JSON 契約)
